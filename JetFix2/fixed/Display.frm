      ...
      Select Case EditTable
         Case Is = "Deposits"
            ...
            DTotal = 0
             ...
             Next F
            End With
            Sql = "Update [Sales] Set [Deposits] = " & Format(Val(DTotal), "0.00") & " where TRY_CAST([Date] AS datetime) = #" & Format(CDate(SearchDate), "MM/DD/YYYY") & "#"
            Cdb.Execute Sql
            DbClose Cdb, RS
         Case Else
...
'DbClose Db, RS
ConnectADODB SvrPath.TerminalPath & ClosingHistory, Db
  Sql = "Select * from [Hourly Sales] Where TRY_CAST([Date] AS datetime) = #" & Format(InDate, "MM/DD/YYYY") & "#"
...
ConnectADODB SvrPath.TerminalPath & ProductHistory, Db
  ...
  Sql = Sql & " Where [Item Price] < 0 and TRY_CAST([Date] AS datetime) Between #" & CDate(SearchDates.Item(1).StartDate + " " + GetStartTime) & "#"
  Sql = Sql & " and #" & SetEndingDate(SearchDates.Item(1).EndDate) + " " + SetEndingTime & "#"
...
'******************************
    ...
    If SummarySheet.TextMatrix(SummarySheet.Row, 0) = "Voids" Then
        ...
        Sql = "Select [Item Name], sum([Amount]) as TotalAmt from [Voids] where [Amount] > 0 and TRY_CAST([Date] AS datetime) Between #" & CDate(SearchDate) & " " & GetStartTime & "# and #" & SetEndingDate(SearchDate) & " " & SetEndingTime & "# group by [Item Name]"
