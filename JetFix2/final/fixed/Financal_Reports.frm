...
Select Case SaleByHow
 Case Is = SalesByHow.ByHour
     ...
     If ByTransaction Then
      ...
      Sql = Sql & " Where TRY_CAST([date] AS date) Between '" & Format(CDate(CDate(StartDate) & " " & GetStartTime), "yyyy-mm-dd hh:nn:ss") & "' and '" & Format(CDate(SetEndingDate(EndDate) & " " & SetEndingTime), "yyyy-mm-dd hh:nn:ss") & "'"
    ...
    Else
     ...
     Sql = Sql & " Where TRY_CAST([date] AS datetime) Between '" & Format(CDate(CDate(StartDate) & " " & GetStartTime), "yyyy-mm-dd hh:nn:ss") & "' and '" & Format(CDate(SetEndingDate(EndDate) & " " & SetEndingTime), "yyyy-mm-dd hh:nn:ss") & "'"
...
RTS = -1
  ConnectADODB MyRegisters(0).Svr & CheckStatDb, CheckStatDb, Db
    ...
    Else
      Sql = Sql & " and cdate([Check Date] & ' ' & [recorded time]) between '" & Format(CDate(CDate(StartDate & " " & GetStartTime)), "yyyy-mm-dd hh:nn:ss") & "' and '" & Format(CDate(CDate(SetEndingDate(EndDate) & " " & SetEndingTime)), "yyyy-mm-dd hh:nn:ss") & "'"
    End If
...
RTS = -1
  ConnectADODB MyRegisters(0).Svr & ProductHistory, ProductHistory, Db
    ...
    Sql = Sql & " and TRY_CAST([Date] AS datetime) Between '" & Format(CDate(CDate(StartDate & " " & GetStartTime)), "yyyy-mm-dd hh:nn:ss") & "'"
